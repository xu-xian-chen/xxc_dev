...
import com.xxc.stream.retailersv1.func.AsyncHbaseDimBaseDicFunc;
import com.xxc.stream.retailersv1.func.IntervalJoinOrderCommentAndOrderInfoFunc;
import com.xxc.stream.retailersv1.utils.CommonGenerateTempLate;
import com.xxc.stream.retailersv1.utils.SensitiveWordsUtils;
import com.xxc.utils.ConfigUtils;
import com.xxc.utils.DateTimeUtils;
...
/**
 * Title: DbusDBCommentFactData2Kafka
 * Author  xuxianchen
 * Package com.xxc.stream.retailersv1.utils
...
public class DbusDBCommentFactData2Kafka {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> kafka_cdc_db_source = env.fromSource(KafkaUtils.buildKafkaSource(
                        ...
                        "kafka_source"
                ).uid("kafka_cdc_db_source")
                .name("kafka_cdc_db_source");

//        kafka_cdc_db_source.print("kafka_cdc_db_source  -->") ;

        //order_info
        SingleOutputStreamOperator<JSONObject> filterOrderInfo = kafka_cdc_db_source
...
//        filterOrderInfo.print("filterOrderInfo  ->") ;
        //评论表
        DataStream<JSONObject> filteredStream = kafka_cdc_db_source
...
//        filteredStream.print("filteredStream ->");
        ...
        enrichedStream.print("enrichedStream  -->");
        ...
        orderCommentMap.print("orderCommentMap  ->");
